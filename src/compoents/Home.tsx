...
const styles = createStyles({
    ...
    SkillButton: {
        marginRight: '3px', backgroundColor: "#008E97", color: "white",
    },
                            ...
                            <Grid item>
                                <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                                    ...
                                    {!showAdditionalSkills && remainingSkills.length > 0 && (
                                        <Button onClick={this.toggleAdditionalSkills} style={{ margin: '5px' }}>
                    ...
                    <Grid item sm={2} style={{ borderLeft: "1px solid lightgrey", marginLeft: "auto" }}>
                        <Grid container spacing={1} style={{ position: "relative" }}>
                            <Grid item style={{ position: "relative", top: "40px" }}>
                                <strong style={{ fontSize: "30px", marginLeft: "68px" }}>$10.00</strong>/hr
                            </Grid>
                            <Grid item style={{ position: "relative", top: "40px", marginLeft:"100px" }}>
                                <p>HourlyPrice</p>
                            </Grid>
                            <Grid item style={{ position: "relative", top: "70px", left:"40px" }}>
